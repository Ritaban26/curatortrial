...
/**
 * Title: Search Fullwidth
 * Slug: lifestyle-blog-arcane/template-search-fullwidth
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0">
  <!-- wp:pattern {"slug":"lifestyle-blog-arcane/hidden-search-results-title"} /-->
  <!-- wp:pattern {"slug":"lifestyle-blog-arcane/hidden-query-loop-2"} /-->
</main>
<!-- /wp:group -->
